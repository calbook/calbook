			...
			<div id="container" class="col-md-8">
				...
				<div class="form">
					<div class ="info">
						<h1>모임/일정 수정</h1>
						<br>
						<span>모임명 :<input  type="text" name="name" value="뭘까요" class="border"></span>
						<span>모임일정 :<input type="text" name="schedule" value="히히" class="border"></span>
						<br><br><br>
					</div>
				  <button  type="button" class ="accept bottom">ACCEPT</button>
				  <button type="button" class="Cancel bottom">CANCEL</button>
				</div>
			</div>		
		</div>
	</div>
