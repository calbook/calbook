  ...
  <div class="column middle">  
    <div class="column half">
    	...
    	<div class="search-box">
  			...
  			<button class="new"><span><i class="fa fa-search"></i></span></button>
  			<button class="new"><span><i class="fa fa-bell"></i></span></button>
		</div>
		...
		<figure class="snip1157">
  			...
  			<div class="author">
    			<h5>Eleanor Faint<span> LIttleSnippets.net</span></h5>
    			<button type="button"><i class="fa fa-check-circle"></i></button>
    			<button type="button"><i class="fa fa-home"></i></button>
  			</div>
		</figure>
